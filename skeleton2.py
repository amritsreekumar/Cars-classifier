    ...
    def __data_generation(self, list_IDs_temp):
        ...
        if self.val == True:
            for i, ID in enumerate(list_IDs_temp):
                # Store sample
                X[i,] = load_img(
                    '/Users/rahulnair/Desktop/personal/UB/courses/cse 673 Comp Vision/Assign2_3/tiny-imagenet-200/val/images/' + ID)
                # print("Val","i ", i, "ID",ID)
                # Store class
                labelid = val_dict[ID]
            ...
            for i, ID in enumerate(list_IDs_temp):
                # Store sample
                X[i,] = load_img(
                    '/Users/rahulnair/Desktop/personal/UB/courses/cse 673 Comp Vision/Assign2_3/tiny-imagenet-200/train/' + ID + '/images/' + ID + '_' + str(
                        i) + '.JPEG')
                # print(X[i,].shape)
                # Store class
...
if __name__ == "__main__":
    ...
    class_ids = open(
        '/Users/rahulnair/Desktop/personal/UB/courses/cse 673 Comp Vision/Assign2_3/tiny-imagenet-200/wnids.txt', "r")
    ...
    train_paths = glob.glob(
        '/Users/rahulnair/Desktop/personal/UB/courses/cse 673 Comp Vision/Assign2_3/tiny-imagenet-200/train/**/*.JPEG',
        recursive=True)
    train_images = []
    ...
    val_data = open(
        '/Users/rahulnair/Desktop/personal/UB/courses/cse 673 Comp Vision/Assign2_3/tiny-imagenet-200/val/val_annotations.txt',
        "r")
    ...
    def model():
        ...
        x = Conv2D(filters=32, kernel_size=(3, 3), strides=(1, 1), input_shape=(64, 64, 3), padding='same',
